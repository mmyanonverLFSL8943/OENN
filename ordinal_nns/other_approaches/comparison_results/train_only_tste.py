...
def parse_args():
    ...
    parser.add_argument('-d', '--dataset_name', type=str, default='usps', required=False,
...
def main(args):
    ...
    vec_data_total, labels = select_dataset(args.dataset_name)
    ...
    if args.sampling == 'selective':
        ...
        triplet_indices = data_utils.SelectiveTripletDataset(vec_data, labels, number_of_triplets,
                                                             args.batch_size, neighbor_indices)
    ...
    print('train-error', data_utils.triplet_error(embedding_TSTE, all_triplets))
    ...
    print('test error', test_trip_error_TSTE)
    print('time:', time_TSTE)
...
if __name__ == "__main__":
    ...
    # axes[2].set_title('MNIST (dim = 50)')
    # axes[2].set_ylim([0, 0.20])
    # plt.tight_layout()
    # fig.savefig('comparison-figs/OENN-TSTE_MNIST_50.eps')
    # plt.show()
